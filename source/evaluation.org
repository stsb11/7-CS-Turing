...
* Touring Turing - End of Unit Self Evaluation
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
...
:HTML_CONTAINER_CLASS: try
:END:
- [[./doc/TouringTuring-EndofUnitEvaluation.docx][Right click here]] then *Save Link As* to save this evaluation template into your homedrive.
